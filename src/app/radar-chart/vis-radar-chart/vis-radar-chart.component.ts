...
@Component({
  selector: 'app-vis-radar-chart',
  templateUrl: './vis-radar-chart.component.html',
  styleUrls: ['./vis-radar-chart.component.css']
})
export class VisRadarChartComponent implements OnInit {
